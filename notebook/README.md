...
- `/home/primeradiant/Documents/git/TiledAttention/notebook/run_study.py`
...
```bash
cd /home/primeradiant/Documents/git/TiledAttention
```
...
sudo -E /home/primeradiant/Documents/git/TiledAttention/.venv/bin/python \
